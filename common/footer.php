...
<div class="footer">
  <footer class="container py-3 mt-2">
    <div class="row">
      <div class="col-md-3 my-2">
        ...
        <div class="d-flex justify-content-center align-items-center flex-column gap-2">
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum, assumenda temporibus ipsam blanditiis dignissimos nihil distinctio dicta asperiores sequi quisquam laudantium libero consequuntur maxime, dolor perferendis, qui voluptas deserunt earum!</p>
        </div>
      </div>
      <div class="col-md-3 my-2">
      ...
      <div class="col-md-3 my-2">
        ...
        <div class="d-flext justify-content-center align-items-center gap-2 flex-column">
          <div class="d-flex  gap-2 my-3">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" class="locicon">
              <path d="M128 252.6C128 148.4 214 64 320 64C426 64 512 148.4 512 252.6C512 371.9 391.8 514.9 341.6 569.4C329.8 582.2 310.1 582.2 298.3 569.4C248.1 514.9 127.9 371.9 127.9 252.6zM320 320C355.3 320 384 291.3 384 256C384 220.7 355.3 192 320 192C284.7 192 256 220.7 256 256C256 291.3 284.7 320 320 320z" />
            </svg>
            <div>
              NH 28 Kasia Kushinagar UP India.
            </div>
          </div>
          <div class="d-flex  gap-2 my-3">
    ...
    <p class="text-center my-2 ">Copyright © <?php echo Date("Y"); ?> - By Company Name, Inc</p>
  </footer>
</div>
<!-- End Footer -->