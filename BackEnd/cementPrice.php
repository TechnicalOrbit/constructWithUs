...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
  if ($_SERVER['REQUEST_METHOD'] == "POST") {
    $cementprice = $_POST['cement'];
    $csql = "UPDATE `price` SET `cement` = '$cementprice' WHERE `price`.`pId` = 1";
  ...
  <div class="d-flex gap-3">
    ...
    <div class="container my-4 mb-5">
      <form method="post" action=<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>>
        <div class="mb-3">
          <label for="cement" class="form-label">Cement Price</label>
          <input type="file" accept="image/*" class="form-control slider" id="cement" name="cement">
        </div>
