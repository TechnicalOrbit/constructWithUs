           ...
           <form action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> method="post" onsubmit="return validateForm()">
             <div class="row">
               ...
               <div class="col-md-6">
                 <label>
                   Phone:
                   <input type="text" name="mobile" id="mobile" required pattern="[0-9]{10}" minlength="10" maxlength="10">
                 </label>
               </div>
               <div class="col-md-12">
                 <label>Choose Material
                   <select name="material" required pattern="[->a-zA-Z]+" id="option">
                     <option value="Select">Choose Material</option>
               ...
               <div class="col-md-12">
                 <label>
                   Query
                   <textarea rows="5" name="msg">Write here...</textarea>
                 </label>
               </div>
               <div class="col-md-3">
